...
import { removeFromCart, addProduct, removeProduct } from '../../redux/cart/CartActions';
import { Link } from 'react-router-dom';
import './Cart.css';
import { ReactComponent as Close} from '../../assets/icons/close.svg';
import { ReactComponent as AddProduct} from '../../assets/icons/add-product.svg';
import { ReactComponent as RemoveProduct} from '../../assets/icons/remove-product.svg';
                            ...
                            props.products.map(product => {
                                return <div className="d-flex justify-content-between align-items-center text-center" key={product.id}>
                                    ...
                                    <div className="w-25 d-flex justify-content-center">
                                        ...
                                        <div onClick={() => props.addProduct({id: product.id})}>
                                            <AddProduct />
                                        </div>
                                        <div onClick={() => props.removeProduct({id: product.id})}>
                                            <RemoveProduct />
                                        </div>
                                        <div className="ml-1" onClick={() => props.removeFromCart({id: product.id})}>
                                            <Close />
                                        </div>
                                    </div>
                                </div>
